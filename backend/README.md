...
## Project Structure
    ...
    ├── keelas_kreations_28687  # Django project configurations
...
1. Clone this repo and `cd keelas_kreations_28687`
...
2. Clone this repo and `cd keelas_kreations_28687`
